       ...
       case "words":
         {
           ...
           while (list.length < numOfWords) {
             ...
             if (iWordCount > wordList.length) {
               ...
               //wordList = lorem[iParagraphCount].split(/\s/gi);
               //wordList[0] = "\n\n" + wordList[0];
             }
             var randomWord=wordList[iWordCount];
       ...
       case 'characters':
         {
           ...
           //Hai
           //ipsum_text = outputString.substring(0, numOfChars+1);
           //console.log(ipsum_text.charAt(numOfChars-1));
           if (ipsum_text.charAt(numOfChars-1)==' '){
             ipsum_text=ipsum_text.substring(0,numOfChars-1)+'o';
           }
           //End Hai
           //console.log(ipsum_text.charAt(numOfChars-1));
           break;
